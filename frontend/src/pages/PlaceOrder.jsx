...
const PlaceOrder = () => {
  ...
  const initPay = (order) => {
    const options = {
      ...
      handler: async (response) => {
        ...
        try {
          const { data } = await axios.post('https://mern-ecommerce-backend-xi.vercel.app/api/order/verifyRazorpay', response, { headers: { token } });
  ...
  const onSubmitHandler = async (event) => {
    ...
    try {
      ...
      switch (method) {
        case 'cod':
          const response = await axios.post('https://mern-ecommerce-backend-xi.vercel.app/api/order/place', orderData, { headers: { token } });
          console.log(response);
          ...
          break;
        case 'stripe':
          const responseStripe = await axios.post('https://mern-ecommerce-backend-xi.vercel.app/api/order/stripe', orderData, { headers: { token } });
        ...
        case 'razorpay':
          const responseRazorpay = await axios.post('https://mern-ecommerce-backend-xi.vercel.app/api/order/razorpay', orderData, { headers: { token } });
