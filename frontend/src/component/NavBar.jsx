...
const NavBar = () => {
    ...
    const {setShowSearch, getCartCount,navigate,setCartItems, setToken, token} = useContext(ShopContext);
     ...
     <Link to='/'><img src={assets.logo} className='w-36' alt='logo'/> </Link> 
      ...
      <div className='flex items-center gap-6'>
       <img onClick={() => setShowSearch(true)} className='w-5 cursor-pointer' src={assets.search_icon} alt="search-icon"/>
        ...
        <img onClick={() => token? null : navigate('/login')} src={assets.profile_icon} alt="profile-icon" className='w-5 curson-pointer' />
           {/* {Dropdown menu} */}
       ...
       <div className='flex flex-col items-center'>
        ...
        <NavLink onClick={() => setVisible(false)} to='/about' className='py-2 pl-6  gap-1'>
            <p>ABOUT</p>   
        </NavLink>
